# version for running on Grani's computer, add warehouses with retail price signal adder
using Gurobi
using JuMP
using REoptLite
...
function linearized_problem_bess_bigM(cpv, ci, clmp, LLnodes, LLnodes_withPV, LLnodes_warehouse, LDFinputs, ULnodes_withBESS; 
    ...
    @variables model begin
        ...
        Mbig >= xe[LLnodes_withPV, 1:T] >= 0        
        Mbig >= xi[LLnodes_warehouse, 1:T] >= 0
        Mbig >= x0[1:T] >= 0
        Mbig >= xbkW[ULnodes_withBESS] >= 0
        Mbig >= xbkWh[ULnodes_withBESS] >= 0
        Mbig >= xsoc[ULnodes_withBESS, 0:T] >= 0
...
function linearized_problem_bess_bigM_bilinear(cpv, ci, clmp, LLnodes, LLnodes_withPV, LLnodes_warehouse, LDFinputs, ULnodes_withBESS; 
    T=8760)
